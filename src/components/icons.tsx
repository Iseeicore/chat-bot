...
export function AttachIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M21.44 11.05l-9.19 9.19a5 5 0 01-7.07-7.07l9.19-9.19a3.5 3.5 0 015 5l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48" />
    </svg>
  );
}
...
export function TicksIcon() {
  return (
    <svg width="13" height="9" viewBox="0 0 16 11" fill="none" stroke="currentColor" strokeWidth="1.6">
      <path d="M1 5.5l3 3 7-8" />
      <path d="M5.5 5.5l3 3 7-8" />
    </svg>
  );
}
